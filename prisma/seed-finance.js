...
const DEFAULT_ACCOUNTS = [
    ...
    { code: '511', name: 'Doanh thu', order: 29 },
    { code: '515', name: 'Doanh thu hoạt động tài chính', order: 30 },
    { code: '621', name: 'Chi phí nguyên vật liệu trực tiếp', order: 31 },
    { code: '622', name: 'Chi phí nhân công trực tiếp', order: 32 },
    { code: '627', name: 'Chi phí sản xuất chung', order: 33 },
    { code: '632', name: 'Giá vốn hàng bán', order: 34 },
    { code: '635', name: 'Chi phí tài chính', order: 35 },
    { code: '641', name: 'Chi phí bán hàng', order: 36 },
    { code: '642', name: 'Chi phí quản lý doanh nghiệp', order: 37 },
    { code: '711', name: 'Thu nhập khác', order: 38 },
    { code: '811', name: 'Chi phí khác', order: 39 },
];

...
// Danh mục Thu tương ứng khi hoàn ứng được nhập TRỰC TIẾP trong Nhật ký Thu – Chi (không qua modal
// "Hoàn ứng" trong chi tiết nhân viên) — dùng để nhận diện phiếu Thu "mồ côi" vẫn tính vào tổng đã
// hoàn ứng của nhân viên. Khớp tên nhóm "Thu hoàn ứng" trong prisma/seed-finance.js.
export const SETTLEMENT_CATEGORY_BY_TYPE = {
    'Lương': 'Thu hồi ứng lương',
    'Công tác': 'Hoàn ứng công tác phí',
    'Vật tư': 'Hoàn ứng mua vật tư',
    'Tiền ăn': 'Hoàn ứng tiền ăn',
};

...
export const DEFAULT_ACCOUNTS = [
    ...
    { code: '1331', name: 'Thuế GTGT được khấu trừ', order: 6 },
    { code: '136', name: 'Phải thu nội bộ', order: 7 },
    { code: '138', name: 'Phải thu khác', order: 8 },
    { code: '141', name: 'Tạm ứng', order: 9 },
    { code: '152', name: 'Nguyên vật liệu', order: 10 },
    { code: '153', name: 'Công cụ dụng cụ', order: 11 },
    { code: '154', name: 'Chi phí SXKD dở dang', order: 12 },
    { code: '156', name: 'Hàng hóa', order: 13 },
    { code: '211', name: 'Tài sản cố định', order: 14 },
    { code: '214', name: 'Hao mòn TSCĐ', order: 15 },
    { code: '242', name: 'Chi phí trả trước', order: 16 },
    { code: '331', name: 'Phải trả người bán', order: 17 },
    { code: '3331', name: 'Thuế GTGT phải nộp', order: 18 },
    { code: '3334', name: 'Thuế TNDN', order: 19 },
    { code: '3335', name: 'Thuế TNCN', order: 20 },
    { code: '3338', name: 'Thuế, phí khác', order: 21 },
    { code: '334', name: 'Phải trả người lao động', order: 22 },
    { code: '338', name: 'Phải trả, phải nộp khác', order: 23 },
    { code: '3382', name: 'Kinh phí công đoàn', order: 24 },
    { code: '3383', name: 'BHXH', order: 25 },
    { code: '3384', name: 'BHYT', order: 26 },
    { code: '3386', name: 'BHTN', order: 27 },
    { code: '341', name: 'Vay và nợ thuê tài chính', order: 28 },
    { code: '353', name: 'Quỹ khen thưởng, phúc lợi', order: 29 },
    { code: '511', name: 'Doanh thu', order: 30 },
    { code: '515', name: 'Doanh thu hoạt động tài chính', order: 31 },
    { code: '621', name: 'Chi phí nguyên vật liệu trực tiếp', order: 32 },
    { code: '622', name: 'Chi phí nhân công trực tiếp', order: 33 },
    { code: '627', name: 'Chi phí sản xuất chung', order: 34 },
    { code: '632', name: 'Giá vốn hàng bán', order: 35 },
    { code: '635', name: 'Chi phí tài chính', order: 36 },
    { code: '641', name: 'Chi phí bán hàng', order: 37 },
    { code: '642', name: 'Chi phí quản lý doanh nghiệp', order: 38 },
    { code: '711', name: 'Thu nhập khác', order: 39 },
    { code: '811', name: 'Chi phí khác', order: 40 },
];

...
// Checklist chuẩn bị trước khi sản xuất/thi công (bóc tách, bản vẽ CNC, vật tư...)
// Lưu vào MfgOrder.prepChecklist dạng JSON [{ label, status, note }]
export const PREP_CHECKLIST_ITEMS = [
    'Đã có bản vẽ sản xuất được duyệt',
    'Đã có bản vẽ CNC gia công nguội (khung sắt, inox, khung kim loại...)',
    'Đã bóc tách kích thước, số lượng từng chi tiết',
    'Đã lập bảng kê khai nguyên vật liệu cần cắt',
    'Đã kiểm tra tồn kho vật tư trước khi cắt',
    'Máy CNC/máy cắt đã kiểm tra, hoạt động tốt',
    'Đã chuẩn bị đủ phụ kiện, vật tư phụ đi kèm',
    'Mặt bằng, khu vực gia công đã sẵn sàng',
];

export const PREP_CHECKLIST_STATUS_LABELS = { pending: 'Chưa kiểm tra', passed: 'Đạt', failed: 'Không đạt' };
...
export const DEFAULT_STAGE_TEMPLATES = [
    ...
    'Lắp ráp thử', 'Sơn/hoàn thiện bề mặt', 'Lắp phụ kiện', 'Kiểm tra QC',
    'Vệ sinh', 'Đóng gói', 'Xuất xưởng', 'Vận chuyển', 'Lắp đặt', 'Nghiệm thu',
].map((name, i) => ({ name, sequence: (i + 1) * 10, isRequired: true }));

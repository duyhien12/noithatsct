...
const quotationCategorySchema = z.object({
    ...
    image: optStr,
    subtotal: optFloat,
    sharedUnit: z.string().trim().optional().default('trọn gói'),
    sharedQuantity: z.number().optional().default(1),
    sharedUnitPrice: z.number().optional().default(0),
...
export const quotationCreateSchema = z.object({
    ...
    promoText: z.string().optional().default(''),
}).strict();

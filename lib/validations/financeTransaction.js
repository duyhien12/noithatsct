...
export const financeTransactionCreateSchema = financeTransactionBaseSchema.strict()
    ...
    .refine(d => d.type !== 'Chi' || !['NCC', 'Thầu phụ'].includes(d.objectType) || !!d.projectId, {
        message: 'Giao dịch Chi cho NCC/Thầu phụ bắt buộc chọn Dự án/Công trình để theo dõi đúng chi phí công trình',
        path: ['projectId'],
    });

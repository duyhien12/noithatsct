...
export const STATUS_COLORS = {
    ...
    'Chờ phản hồi': { bg: '#EDE9FE', text: '#7C3AED' },
    'Việc tạm dừng': { bg: '#F1F5F9', text: '#64748B' },
    'Hoàn thành': { bg: '#DBEAFE', text: '#2563EB' },
    'Lưu trữ': { bg: '#E5E7EB', text: '#4B5563' },
};

export const DONE_STATUSES = ['Hoàn thành', 'Lưu trữ'];

// Riêng "Lưu trữ" — dùng cho nút ẩn/hiện lưu trữ riêng biệt với "Ẩn Hoàn thành".
export const ARCHIVED_STATUSES = ['Lưu trữ'];
...
export const DESIGNERS = ['Phạm Thành Đông', 'Đào Lê Nhật Mai', 'Nguyễn Thị Hương Lý'];

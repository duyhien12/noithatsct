                    ...
                    >
                        ...
                        {dayHeaders.map((d, i) => (
                            <g key={i}>
                                ...
                                <text x={LABEL_W + i * colW + colW / 2} y={HEADER_H - 5} fill={d.isToday ? '#fff' : d.day === 1 ? '#fff' : 'rgba(255,255,255,0.8)'} fontSize={7} textAnchor="middle" fontWeight={d.isToday || d.day === 1 ? 'bold' : 'normal'}>{d.day}</text>
                            </g>
                        ))}

                                ...
                                {viewMode === 'list' && (<>
                                    <table className="data-table" style={{ fontSize: 12 }}>
                                        <thead><tr>
                                            ...
                                            <th style={{ width: 38 }}>Ảnh</th><th style={{ width: 90 }}>Mã SP</th><th style={{ minWidth: 160 }}>Tên SP</th><th style={{ width: 120 }}>Kích thước</th><th style={{ width: 45 }}>ĐVT</th>
                                        ...
                                        <tbody>{filteredP.map(p => {
                                            ...
                                            return (<tr key={p.id} draggable={!isQE}
                                                ...
                                                <td data-no-drag="true" style={{ padding: '4px 6px', whiteSpace: 'nowrap' }}><InlineCodeCell value={p.code} onSave={v => quickUpdateCode(p.id, v)} onCopy={() => copyCode(p.code)} /></td>

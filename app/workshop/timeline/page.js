                                ...
                                {Object.entries(grouped).map(([projectName, { tasks: gt }]) => {
                                    ...
                                    return (
                                        <div key={projectName}>
                                            ...
                                            >
                                                <div style={{ minWidth: LEFT_W, padding: '5px 10px', fontSize: 12, fontWeight: 700, color: pLate ? '#dc2626' : pDone ? '#16a34a' : '#1d4ed8', borderRight: '2px solid var(--border)', flexShrink: 0, display: 'flex', alignItems: 'center', gap: 5 }}>
                                            ...
                                            {!isCollapsed && gt.map(task => {
                                                ...
                                                return (
                                                    <div key={task.id} style={{
                                                        ...
                                                        {/* Left pane */}
                                                        <div style={{ minWidth: LEFT_W - 3, padding: '7px 12px', paddingLeft: 12 + indent, borderRight: '2px solid var(--border)', flexShrink: 0, display: 'flex', alignItems: 'center', gap: 6 }}>
